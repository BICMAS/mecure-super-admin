      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative z-10 flex flex-col md:flex-row">
        <div className="p-8 w-full">
          <div className="text-center mb-8">
            ...
            />
            <h1 className="text-2xl font-bold text-brand-primary tracking-tight font-display">MeCure Excellence Academy</h1>
            <p className="text-sm text-gray-500 mt-2">Digital Platform · Super Admin</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
           ...
           {error && (
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-brand-primary hover:bg-brand-primary-dark text-white font-semibold py-2.5 rounded-lg transition-all transform active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg shadow-brand-primary/30 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              ...
              {!resetSent ? (
                <form onSubmit={handleForgotPassword} className="space-y-4">
                  ...
                  <button 
                    ...
                    className="w-full bg-brand-primary hover:bg-brand-primary-dark text-white font-semibold py-2.5 rounded-lg transition-all disabled:opacity-70"
                  >
